...
if ( ! function_exists( 'lustshop_setup' ) ) :
	...
	function lustshop_setup() {
		 ...
		 * If you're building a theme based on lustshop, use a find and replace
		 * to change 'lustshop' to the name of your theme in all the template files.
		 */
 ...
 */
function lustshop_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'lustshop_content_width', 640 );
}
add_action( 'after_setup_theme', 'lustshop_content_width', 0 );
