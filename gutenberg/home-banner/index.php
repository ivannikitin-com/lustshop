...
function render_block_lustshop_home_banner ($attributes) {
	ob_start();
	?>
<div class="lutshop-home-banner"
	style="background: #1e2027 url(<?php echo get_bloginfo('template_directory'); ?>/src/img/home-banner/bg-main-1.jpg) 50% 0 no-repeat; background-size: cover;">
					...
					<div class="mt-5"><a href="<?php echo $attributes['buttonLink']; ?>"
							...
							<svg class="icon" xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12">
								<path data-name="-e-arrow-white"
									...
									fill="#fff" fill-rule="evenodd" /></svg></a></div>
				</div>
				<div class="col-lg-6 lutshop-home-banner__picture d-none d-lg-block"><img
						src="<?php echo get_bloginfo('template_directory'); ?>/src/img/home-banner/girl-1-2.png"
						class="img-fluid lutshop-home-banner__img"></div>
			</div>
		</div>
	</div>
</div>
