...
<div class="yith-wcwl-add-button">
  <a class="wp-block-lustshop-button product__wishlist"
    href="<?php echo esc_url(add_query_arg('remove_from_wishlist', $product_id, $base_url)); ?>" rel="nofollow"
    data-item-id="<?php echo esc_attr($found_item->get_id()); ?>" data-product-id="<?php echo esc_attr($product_id); ?>"
