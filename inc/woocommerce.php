...
function lustshop_woocommerce_scripts() {
	wp_enqueue_style( 'lustshop-woocommerce-style', get_template_directory_uri() . '/dist/css/woocommerce.css' );
	...
	wp_add_inline_style( 'lustshop-woocommerce-style', $inline_font );
}
